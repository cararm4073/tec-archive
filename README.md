...
| [Herramientas computacionales: el arte de la programación](https://github.com/cararm4073/proyectoFinal-ArteProgramacion25) | TC1001S | Learn to use the terminal | Write and edit program's files, compile and install software from the terminal. Learn to use GIT for version management and the WSL (Windows Subsystem for Linux | Python, Terminal, WSL |
...
![GCC](https://img.shields.io/badge/GCC-FFCF00?style=for-the-badge&logo=gnu&logoColor=black)
...
The code published in this repo is for educational, historical and portfolio purposes. If you are a current student, somehow found this repo, and are taking these courses or similars:
...
Please respect the institution's ethical standards. Use this repository to learn, not to copy.
